<x-admin-layout>
    ...
    <div class="max-w-3xl mx-auto space-y-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-bold text-slate-800">Tambah Foto</h1>
                <p class="text-slate-500">Unggah foto dokumentasi kegiatan baru</p>
            </div>
        </div>
        ...
        <form action="{{ route('admin.galeri.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div x-data="{ preview: null }" class="space-y-4">
                <label class="block text-sm font-medium text-slate-700 mb-1">Foto Kegiatan <span
                ...
                <div class="flex flex-col items-center justify-center w-full">
                    <label for="gambar"
                        ...
                        <div class="flex flex-col items-center justify-center pt-5 pb-6" x-show="!preview">
                            <svg class="w-10 h-10 mb-3 text-slate-400 group-hover:text-emerald-500 transition-colors"
                                fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z">
                                </path>
                            </svg>
                            <p class="mb-2 text-sm text-slate-500"><span class="font-semibold">Klik untuk upload</span>
                                atau drag and drop</p>
                            <p class="text-xs text-slate-500">PNG, JPG, WEBP up to 5MB</p>
                        </div>

                        <!-- Preview State -->
                        <div x-show="preview" class="w-full relative">
                            <img :src="preview" class="w-full h-auto object-contain">
                            <div
                                class="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                                <p class="text-white font-medium">Ganti Foto</p>
                            </div>
                        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="date" name="tanggal_foto" id="tanggal_foto"
                        value="{{ old('tanggal_foto', date('Y-m-d')) }}"
                ...
                <div class="col-span-full">
                    ...
                    <textarea name="deskripsi" id="deskripsi" rows="3"
                        ...
                        placeholder="Jelaskan sedikit tentang momen ini...">{{ old('deskripsi') }}</textarea>
                    @error('deskripsi')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="col-span-full">
                    <div class="flex items-start">
                        <div class="flex items-center h-5">
                            <input id="is_featured" name="is_featured" value="1" type="checkbox" {{ old('is_featured') ? 'checked' : '' }}
