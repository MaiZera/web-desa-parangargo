                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('admin.sponsors.update', $sponsor) }}" method="POST"
                        ...
                        <div>
                            ...
                            @if($sponsor->logo)
                                <div class="mt-2 mb-2">
                                    <img src="{{ Storage::url($sponsor->logo) }}" alt="Current Logo"
                                        class="h-20 w-auto object-contain border p-1 rounded">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="url" name="website" id="website"
                                    value="{{ old('website', $sponsor->website) }}" placeholder="https://example.com"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                @error('website')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <div class="mt-1 flex rounded-md shadow-sm">
                                    ...
                                    <input type="text" name="instagram" id="instagram"
                                        value="{{ old('instagram', $sponsor->instagram) }}" placeholder="username"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" name="urutan" id="urutan"
                                    value="{{ old('urutan', $sponsor->urutan) }}" min="0" required
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                            </div>
