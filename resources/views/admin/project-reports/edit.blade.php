        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('admin.project-reports.update', $projectReport->id) }}" method="POST"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div>
                                ...
                                <input type="text" name="title" id="title"
                                    value="{{ old('title', $projectReport->title) }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="location" id="location"
                                    value="{{ old('location', $projectReport->location) }}"
                                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-emerald-500 focus:ring focus:ring-emerald-200"
                                    required>
                                @error('location')
                                    <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div>
                                ...
                                <input type="text" name="rt" id="rt" value="{{ old('rt', $projectReport->rt) }}"
                                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-emerald-500 focus:ring focus:ring-emerald-200">
                                @error('rt')
                                    <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="text" name="rw" id="rw" value="{{ old('rw', $projectReport->rw) }}"
                                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-emerald-500 focus:ring focus:ring-emerald-200">
                                @error('rw')
                                    <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="description" id="description" rows="4"
                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-emerald-500 focus:ring focus:ring-emerald-200"
                                required>{{ old('description', $projectReport->description) }}</textarea>
                            @error('description')
                                <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                            <div>
                                ...
                                <input type="number" name="percentage" id="percentage"
                                    value="{{ old('percentage', $projectReport->percentage) }}" min="0" max="100"
                                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-emerald-500 focus:ring focus:ring-emerald-200"
                                    required>
                                @error('percentage')
                                    <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                            ...
                            <div>
                                ...
                                <select name="status" id="status"
                                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-emerald-500 focus:ring focus:ring-emerald-200"
                                    required>
                                    <option value="Pending" {{ old('status', $projectReport->status) == 'Pending' ? 'selected' : '' }}>
                                        Pending</option>
                                    <option value="On Progress" {{ old('status', $projectReport->status) == 'On Progress' ? 'selected' : '' }}>On Progress</option>
                                    <option value="Selesai" {{ old('status', $projectReport->status) == 'Selesai' ? 'selected' : '' }}>
                                        Selesai</option>
                                </select>
                                @error('status')
                                    <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                            ...
                            <div>
                                ...
                                <input type="number" name="fund_usage" id="fund_usage"
                                    value="{{ old('fund_usage', $projectReport->fund_usage) }}"
                                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-emerald-500 focus:ring focus:ring-emerald-200"
                                    required>
                                @error('fund_usage')
                                    <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                        ...
                        <div class="mb-6">
                            ...
                            @if($projectReport->image)
                                <div class="mb-2" id="currentImage">
                                    ...
                                    <img src="{{ asset('storage/' . $projectReport->image) }}" alt="Current Image"
                            ...
                            @error('image')
                                <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                            @else
                                <p class="text-xs text-gray-500 mt-1">Maksimal ukuran file: 5MB. Biarkan kosong jika tidak
