                                ...
                                <thead>
                                    <tr class="text-gray-400 border-b border-gray-100">
                                        ...
                                        <th class="px-6 py-4 text-xs font-semibold uppercase tracking-wider">Status &
                                            Tanggal</th>
                                        <th class="px-6 py-4 text-xs font-semibold uppercase tracking-wider">Penulis
                                        </th>
                                        <th class="px-6 py-4 text-xs font-semibold uppercase tracking-wider">Actions
                                        </th>
                                    </tr>
                                </thead>
                                                    ...
                                                    @if($item->file_lampiran)
                                                        <div
                                                            ...
                                                            @if(in_array(strtolower($ext), ['jpg', 'jpeg', 'png', 'gif']))
                                                                <img src="{{ asset('storage/' . $item->file_lampiran) }}"
