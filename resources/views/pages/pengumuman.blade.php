    ...
    <div class="space-y-6">
        ...
        <div class="bg-white border border-slate-100 rounded-[2rem] p-8 shadow-sm hover:shadow-md transition-shadow flex flex-col md:flex-row gap-6 items-start cursor-pointer group">
            ...
            <div class="shrink-0 flex md:flex-col gap-2 w-full md:w-auto">
                ...
                <a href="{{ route('news.announcement.show', 'kerja-bakti-massal') }}" class="flex-1 md:flex-none bg-white border border-slate-200 text-slate-600 px-6 py-3 rounded-xl font-bold text-sm hover:bg-slate-50 transition-colors text-center">Detail</a>
            </div>
        </div>
