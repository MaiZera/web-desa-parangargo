...
@section('content')
    <div class="py-12 px-4 max-w-7xl mx-auto space-y-12">
        <div class="max-w-3xl">
            ...
            <p class="text-lg text-slate-600">Urus berbagai dokumen kependudukan dan perizinan lebih cepat secara online
                atau unduh formulir untuk pengurusan di kantor desa.</p>
        </div>
