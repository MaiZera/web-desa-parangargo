...
class UmkmController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'foto_produk' => 'nullable|image|mimes:jpeg,png,jpg|max:5120',
            'is_active' => 'boolean',
            ...
            'foto_produk.max' => 'Ukuran gambar maksimal 5MB.',
            'foto_produk.mimes' => 'Format gambar harus jpeg, png, atau jpg.',
            'foto_produk.uploaded' => 'Gagal mengupload gambar. Ukuran file mungkin melebihi batas server.',
